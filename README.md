...
```cli
touch /swapfile;fallocate -l 1G /swapfile;chmod 600 /swapfile;mkswap /swapfile;swapon /swapfile;sudo apt update -y; apt dist-upgrade -y; apt install nodejs -y;apt install npm -y; npm i -g n; n stable; PATH=$PATH; sudo apt install certbot python3-certbot-apache -y;npm i -g pm2;apt install nginx -y;npm i -g yarn;
```
